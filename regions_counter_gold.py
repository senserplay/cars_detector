...
def mouse_callback(event, x, y, flags, param):
    ...
    Notes:
        ...
        - Requires the existence of the 'created_regions' list and the 'Polygon' class.

    Example:
        >>> cv2.setMouseCallback(window_name, mouse_callback)
    """
    global current_region, current_zone_points, color_index
...
def run(
    ...
    while videocapture.isOpened():
        if not paused:  # Если не на паузе, продолжаем читать кадры
