from video_processors.video_processing import VideoProcessor
from video_processors.region_selection import RegionSelector
from video_processors.car_detection import CarDetector
